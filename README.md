...
- ☁️ Building scalable cloud-native applications on **AWS**
- 🤖 Designing **AI Agents, RAG Systems & LLM-powered Applications**
- 🚀 Shipping SaaS products from idea to production
- 🏗️ Passionate about distributed systems, cloud architecture and developer tooling
- 🔓 Open Source Contributor to **Strands Agents SDK**
- ♟️ Outside work: Chess, swimming, startups and technology
...
⚡ FastAPI, React & Full-Stack Platforms
🚀 Multi-Tenant SaaS Products
📊 Cloud Analytics & Observability Systems
...
<p align="center">
  <i>Building cloud-native and AI-powered products that solve real-world problems.</i>
</p>
